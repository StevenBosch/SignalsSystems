...
ans2 = micfunction(0, v_sound/400, 2, [0, 0], [0, 0.5*v_sound/400], [5, 5], [400, 400], [0, 0], 8000)
plot((1:200), gensinusoid(5,400,0,0,0.5,8000)(1:200), (1:200),ans(1:200), (1:200), ans2(1:200))
xlabel("Sample")
ylabel("Amplitude (A)")
