...
We used the script we wrote in (a) to create a numerical example, given in answer (c), that shows this phenomenon for the extreme case that two signals double each other for one microphone,
while they cancel each other out for the second microphone (see also \autoref{code:2bc}.

\subsection{}
See \autoref{code:2bc} for the script we wrote. \autoref{fig2bc}

\begin{figure}[H]
  \centering
  \includegraphics[width=0.7\columnwidth]{plot2B.eps}\\
  \caption{}
  \label{fig2bc}
\end{figure}
